...
# gem 'dotenv-rails'          # Use .env file instead of real ENV, should be at the very top to load as early as possible
...
gem 'rubyzip'               # Ruby module for reading and writing zip files
