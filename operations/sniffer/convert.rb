module Sniffer
  class Convert < ::Operations::Base
    ...
    private
      ...
      # return nil in it is impossible to join
      def join_routes_nodes(sequence)
        time_node = @node_times_hash[sequence[:node_time_id]]
        start_time = @routes_hash[sequence[:route_id]]
